...
# Title
st.title("Arterial Blood Gas (ABG) Interpretation Tool")

# Introduction
st.write("""
**Introduction:**
Interpreting an arterial blood gas (ABG) is crucial for healthcare professionals, especially in critically ill patients. 
This tool follows a six-step process to help you interpret ABG values accurately.
""")
...
if acid_base_status == "Acidemia":
    st.write("The patient exhibits acidemia which could be due to either respiratory or metabolic acidosis.")
elif acid_base_status == "Alkalemia":
    st.write("The patient exhibits alkalemia which could be due to either respiratory or metabolic alkalosis.")
else:
    st.write("The patient's acid-base status is within normal limits.")

if anion_gap > 12:
    st.write("An elevated anion gap suggests the presence of metabolic acidosis.")
else:
    st.write("The anion gap is within normal limits.")

if osm_gap > 10:
    st.write("The osmolar gap indicates the presence of an abnormal solute, possibly due to intoxication.")

st.write("### Follow the six-step approach for complete ABG interpretation.")
